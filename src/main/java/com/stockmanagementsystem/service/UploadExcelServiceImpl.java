            ...
            for (Row data : sheet) {
                ...
                if (lastCellNum != -1) {
                    ...
                    if (emptyCellCount != data.getLastCellNum()) {
                        ...
                        String inspection = getCellStringValue(data, ServiceConstants.CELL_INDEX_9, resultResponses, type, headerNames);
                        String issueType = getCellStringValue(data, ServiceConstants.CELL_INDEX_10, resultResponses, type, headerNames);
                        String classABC = getCellStringValue(data, ServiceConstants.CELL_INDEX_11, resultResponses, type, headerNames);
                        String attribute = getCellStringValue(data, ServiceConstants.CELL_INDEX_12, resultResponses, type, headerNames);
                        String source = getCellStringValue(data, ServiceConstants.CELL_INDEX_13, resultResponses, type, headerNames);
                        String uom = getCellStringValue(data, ServiceConstants.CELL_INDEX_14, resultResponses, type, headerNames);
                        Float itemUnitWeight = getCellFloatValue(data, ServiceConstants.CELL_INDEX_15, resultResponses, type, headerNames);
                        String code = getCellStringValue(data, ServiceConstants.CELL_INDEX_16, resultResponses, type, headerNames);
                        String types = getCellStringValue(data, ServiceConstants.CELL_INDEX_17, resultResponses, type, headerNames);
                        String dimensionUOM = getCellStringValue(data, ServiceConstants.CELL_INDEX_18, resultResponses, type, headerNames);
                        Float width = getCellFloatValue(data, ServiceConstants.CELL_INDEX_19, resultResponses, type, headerNames);
                        Float height = getCellFloatValue(data, ServiceConstants.CELL_INDEX_20, resultResponses, type, headerNames);
                        Float length = getCellFloatValue(data, ServiceConstants.CELL_INDEX_21, resultResponses, type, headerNames);
                        Float circumference = getCellFloatValue(data, ServiceConstants.CELL_INDEX_22, resultResponses, type, headerNames);
                        Float weight = getCellFloatValue(data, ServiceConstants.CELL_INDEX_23, resultResponses, type, headerNames);
                        Integer itemQty = getCellIntegerValue(data, ServiceConstants.CELL_INDEX_24, resultResponses, type, headerNames);
                        Integer minimumOrderQty = getCellIntegerValue(data, ServiceConstants.CELL_INDEX_25, resultResponses, type, headerNames);
                        Integer optimumLevel = getCellIntegerValue(data, ServiceConstants.CELL_INDEX_26, resultResponses, type, headerNames);
                        Integer reorderLevel = getCellIntegerValue(data, ServiceConstants.CELL_INDEX_27, resultResponses, type, headerNames);
                        Integer safetyLevel = getCellIntegerValue(data, ServiceConstants.CELL_INDEX_28, resultResponses, type, headerNames);
                        Integer criticalLevel = getCellIntegerValue(data, ServiceConstants.CELL_INDEX_29, resultResponses, type, headerNames);
                        String dockId = getCellStringValue(data, ServiceConstants.CELL_INDEX_30, resultResponses, type, headerNames);
                        String dockName = getCellStringValue(data, ServiceConstants.CELL_INDEX_31, resultResponses, type, headerNames);
...
//                        }
                        ...
                        if (isQCRequired != null) {
                            if (isQCRequired.equalsIgnoreCase("yes")) {
                                ...
                                resultResponses.add(new ValidationResultResponse(type, (data.getRowNum() + 1), ServiceConstants.QC_REQUIRED, ServiceConstants.YES_NO));
                            }
                        } else {
