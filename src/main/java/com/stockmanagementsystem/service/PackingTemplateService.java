...
//
//    BaseResponse<PackingProfileConfigMaster> savePackingProfileConfig(PackingProfileConfigRequest request);
//
//    BaseResponse<PackingProfileResponse> getPackingProfileByIdProperly(Long id);
//}
