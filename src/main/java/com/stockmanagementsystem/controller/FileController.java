...
public class FileController {
    ...
    public ResponseEntity<BaseResponse> uploadExcelFile(@RequestPart("file") MultipartFile file,@RequestParam("type") String type,@RequestParam(required = false) String requestType,@RequestParam(required = false) Integer requestId,@RequestParam(required = false) Boolean isFinalUpload) throws IOException, ValidationFailureException {
